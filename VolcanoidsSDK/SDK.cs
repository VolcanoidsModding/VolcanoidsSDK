...
namespace VolcanoidsSDK
{
    ...
    public class SDK
    {
        ...
        /// <param name="appIdentifier">    Your Unique appIdentifier, This is very Important. </param>
        ///-------------------------------------------------------------------------------------------------
        public SDK(string name, string appIdentifier)
        {
            Debug.Log("Volcanoids Modding SDK Version " + version + " has been Enabled for Mod " + name);
            if (name == null)
            {
            ...
            ModID = GUID.Parse(appIdentifier);
        }
    }
    ...
    public class Functions
    {
        ...
        /// <param name="name">             The Spaced Name of your Module. </param>
        /// <param name="desc">             The Description of your Module. </param>
        /// <param name="guidstring">       The GUID in GUID Form for your module. </param>
        /// <param name="categoryname">     The Category in which your Module is in. </param>
        /// <param name="factorytypename">  The Factory Type that is Module is a Part of. </param>
        /// <param name="iconPath">         Full pathname of the icon file. </param>
        /// <param name="categoryList">     Array of Strings for Categories for the Module Item to be
        ...
        public void CreateModule(string codename, string variantname, int maxstack, string baseitem, LocalizedString name, LocalizedString desc, GUID guidstring, string categoryname, string factorytypename, string iconPath, string[] categoryList, bool looping)
        {
            if (Enabled)
            {
                Sprite icon = SpriteGenerator.GenerateSprite(iconPath);
        ...
        public void CreateItem(string codename, int maxstack, LocalizedString name, LocalizedString desc, GUID guidstring, string recipecategoryname, string iconPath)
        {
            if (Enabled)
            {
                Sprite icon = SpriteGenerator.GenerateSprite(iconPath);
        ...
        public void CreateDeposit(bool Underground, int PercentageToReplace, string outputname, float minyield, float maxyield, GUID ItemToReplace)
        {
            if (Enabled)
            {
                Deposit.CreateDeposit(Underground, PercentageToReplace, outputname, minyield, maxyield, ItemToReplace);
        ...
        public void CreateRecipe(string recipeName, lib.classes.Input[] inputs, lib.classes.Output[] outputs, string baseRecipe, GUID itemId, string[] requiredItems, string recipeCategory)
        {
            if (Enabled)
            {
                RecipeCreator.CreateRecipe(recipeName, inputs, outputs, baseRecipe, itemId, requiredItems, recipeCategory);
        ...
        public void CreateStation(string factoryTypeName, string codename, int maxStack, LocalizedString name, LocalizedString desc, GUID guidString, string iconPath, string variantname, string[] categoryList)
        {
            if (Enabled)
            {
                FactoryType factoryType = FindFactoryCategories.FindFactoryNames(factoryTypeName);
